...
{
#ifdef DEBUG
	termprint("dentro a test1\n", 0);
#endif

	SYSCALL(VERHOGEN, (int)&testsem, 0, 0); /* V(testsem)   */

#ifdef DEBUG
	termprint("dentro a test dopo chiamata syscall verhogen\n", 0);
#endif
...
void p4()
{
	...
	if (SYSCALL(TERMINATEPROCESS, (int)&p42id, 0, 0) < 0)
	{ /* terminate p4      */
